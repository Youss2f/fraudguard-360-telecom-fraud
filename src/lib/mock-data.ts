...
export function generateMockData(searchQuery: string, searchType: "msisdn" | "imsi", scenario?: DemoScenario): SubscriberData {
  ...
  return {
    ...
    overallActivity: {
      ...
      locationClusters: [
        { cellSite: "NYC_001_A", frequency: 45, coordinates: { lat: 40.7128, lng: -74.0060 } },
    ...
    dataUsage: {
      ...
      apnUsage: isHighRisk ? [
        { apn: "internet.vzw", sessions: 4567, volume: 89.2, imeis: [imeis[0], imeis[1] || imeis[0], imeis[2] || imeis[0]] },
      ...
      tetheringChecks: isHighRisk ? [
        { imei: imeis[1] || imeis[0], apn: "internet.vzw", suspiciousActivity: true, reason: "High data usage pattern" },
    ...
    dealerAssociation: {
      ...
      recentActivations: [
        ...
        { msisdn: "+1234567892", activationDate: "2024-01-19T11:15:00Z", status: "Active", riskFlags: ["Bulk activation"] },
        { msisdn: "+1234567893", activationDate: "2024-01-18T16:45:00Z", status: "Suspended", riskFlags: ["Suspicious documents"] }
      ]
    },
    rechargePayment: {
      stats: {
