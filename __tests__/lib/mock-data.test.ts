...
describe("Mock Data Generation", () => {
  describe("generateMockData", () => {
    ...
    it("should generate realistic IMEI numbers", () => {
      ...
      expect(result.overview.deviceInfo.imeiHistory.length).toBeGreaterThan(0)
  ...
  describe("Data Consistency", () => {
    ...
    it("should generate realistic activity patterns", () => {
      ...
      expect(result.overallActivity.summary.totalCalls.outgoing + result.overallActivity.summary.totalCalls.incoming).toBeGreaterThan(0)
      ...
      expect(result.overallActivity.timeSeries).toHaveLength(30)
      result.overallActivity.timeSeries.forEach((dataPoint: any) => {
